  ...
  const categories = [
    {
      ...
      image: "https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=300&h=200&fit=crop&crop=center",
      link: "/cakes"
    },
    {
      name: "Birthday Cakes",
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Discover our handcrafted cakes, cupcakes, and pastries made with the finest ingredients 
                  and lots of love. Every bite tells a story of tradition and excellence.
                </p>
              </div>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-cake-pink hover:bg-cake-pink/90 text-white px-8 py-3 text-lg">
                  Shop Now
                </Button>
                <Button variant="outline" size="lg" className="border-cake-pink text-cake-pink hover:bg-cake-pink/10 px-8 py-3 text-lg">
                  Custom Orders
                </Button>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-foreground mb-4">Featured Delights</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover our most popular and beloved creations, crafted with premium ingredients and artistic flair.
            </p>
          </div>
          
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredCakes.map((cake) => (
              <Card key={cake.id} className="group hover:shadow-lg transition-all duration-300 border-cake-pink/20 hover:border-cake-pink/40">
                <div className="relative">
                  <img 
                    src={cake.image} 
                    alt={cake.name}
                ...
                <CardContent className="p-4">
                  <div className="space-y-2">
                    <Badge variant="outline" className="text-xs text-cake-pink border-cake-pink/30">
                      {cake.category}
                    </Badge>
                ...
                <CardFooter className="p-4 pt-0 flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => handleToggleWishlist(cake)}
                    title={isInWishlist(cake.id) ? "Remove from wishlist" : "Add to wishlist"}
                  >
                    <Heart className={cn("h-4 w-4", isInWishlist(cake.id) && "fill-current")} />
                  </Button>
                </CardFooter>
          ...
          <div className="text-center mt-12">
            <Button variant="outline" size="lg" className="border-cake-pink text-cake-pink hover:bg-cake-pink/10">
              View All Products
            </Button>
          </div>
        </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              From intimate celebrations to grand occasions, we have the perfect sweet treats for every moment.
            </p>
          </div>
