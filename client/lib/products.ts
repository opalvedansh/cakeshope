...
export const PRODUCTS: Product[] = [
  ...
  // Additional Cakes
  {
    ...
    category: "Chocolate Cakes",
    description: "Traditional German cake with chocolate sponge, cherries, and whipped cream.",
    isNew: false,
    isBestseller: true,
    inStock: true
  },
  {
    ...
    rating: 5.0,
    reviews: 67,
    image: "https://images.unsplash.com/photo-1535254973040-607b474cb50d?w=400&h=300&fit=crop&crop=center",
    category: "Wedding Cakes",
    description: "Three-tier wedding cake decorated with handcrafted sugar roses and gold accents.",
    isNew: false,
    isBestseller: true,
    inStock: true
  },
  {
    ...
    rating: 4.6,
    reviews: 189,
    image: "https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=400&h=300&fit=crop&crop=center",
    category: "Birthday Cakes",
    description: "Colorful funfetti cake with rainbow sprinkles and vanilla buttercream.",
    isNew: false,
    isBestseller: true,
    inStock: true
  },
  ...
  // Additional Cupcakes
  {
    ...
    category: "Cupcakes",
    description: "Set of 12 chocolate cupcakes with mint buttercream and chocolate chips.",
    isNew: true,
    isBestseller: false,
    inStock: true
  },
  {
    ...
    category: "Cupcakes",
    description: "Set of 12 vanilla cupcakes with swirled vanilla buttercream frosting.",
    isNew: false,
    isBestseller: true,
    inStock: true
  },
  {
    ...
    rating: 4.8,
    reviews: 145,
    image: "https://images.unsplash.com/photo-1550617931-e17a7b70dce2?w=400&h=300&fit=crop&crop=center",
    category: "Cupcakes",
    description: "Set of 12 lemon cupcakes with fresh blueberries and lemon cream cheese frosting.",
    isNew: false,
    isBestseller: false,
    inStock: true
  },
  {
    ...
    rating: 4.9,
    reviews: 112,
    image: "https://images.unsplash.com/photo-1599785209707-a456fc1337bb?w=400&h=300&fit=crop&crop=center",
    category: "Cupcakes",
    description: "Set of 12 vanilla cupcakes with salted caramel buttercream and caramel drizzle.",
    isNew: true,
    isBestseller: true,
    inStock: true
  },
  ...
  // Additional Pastries
  {
    ...
    category: "Pastries",
    description: "Elegant tower of 24 assorted French macarons in various flavors.",
    isNew: false,
    isBestseller: true,
    inStock: true
  },
  {
    ...
    category: "Pastries",
    description: "Box of 8 fresh croissants - plain, almond, and chocolate varieties.",
    isNew: false,
    isBestseller: false,
    inStock: true
  },
  {
    ...
    category: "Pastries",
    description: "Set of 6 Danish pastries with seasonal fruit toppings and cream cheese.",
    isNew: false,
    isBestseller: false,
    inStock: true
  },
  {
    ...
    category: "Pastries",
    description: "Set of 6 éclairs with chocolate, vanilla, and coffee cream fillings.",
    isNew: true,
    isBestseller: false,
    inStock: true
  }
